function New-XlsxTestBytes {
    param(
        ...
        [switch]$DuplicateBusinessNameCell,[switch]$FormulaBenefit,[switch]$UnrelatedUnsupportedRow,[switch]$UnmappedUnsupportedCell,[switch]$DuplicateBenefitHeader,[switch]$MergedBusinessHeader,
        [switch]$DuplicateRelationshipId,[switch]$DuplicateWorksheetTarget,[switch]$ExternalRelationship,[switch]$WrongRelationshipType,[switch]$WorkbookDtd,[switch]$UnsafeArchivePath,
